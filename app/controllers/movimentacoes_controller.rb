class MovimentacoesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @movimentacao.save
        format.html { redirect_to movimentacoes_url, notice: "Movimentação foi criada com sucesso." }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to movimentacoes_url, notice: "Movimentação foi apagada com sucesso." }
